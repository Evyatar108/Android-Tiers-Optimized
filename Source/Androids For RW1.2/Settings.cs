...
namespace MOARANDROIDS
{
    public class Settings : ModSettings
    {
        ...
        public static float percentageOfBatteryChargedEach12Sec = 0.10f;
        ...
        public static void DoSettingsWindowContents(Rect inRect)
        {
            ...
            list.Label("ATPP_SettingsPercentageOfAndroidBatteryReloadedEachXSec".Translate((int)(percentageOfBatteryChargedEach12Sec * 100)));
            percentageOfBatteryChargedEach12Sec = list.Slider(percentageOfBatteryChargedEach12Sec, 0.01f, 1.0f);
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look<float>(ref percentageOfBatteryChargedEach12Sec, "percentageOfBatteryChargedEach12Sec", 0.05f);
